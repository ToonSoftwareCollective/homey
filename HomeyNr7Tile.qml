...
Tile {
	...
	onVisibleChanged: {
        if (visible) {
			app.tile7visible = true
			if (debugOutput) console.log("*********Homey app.tile7visible = true")
        }else{
			app.tile7visible = false
			if (debugOutput) console.log("*********Homey app.tile7visible = false")
		}
    }
