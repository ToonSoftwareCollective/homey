...
Tile {
	...
	onVisibleChanged: {
        if (visible) {
			app.tile9visible = true
			if (debugOutput) console.log("*********Homey app.tile9visible = true")
        }else{
			app.tile9visible = false
			if (debugOutput) console.log("*********Homey app.tile9visible = false")
		}
    }
