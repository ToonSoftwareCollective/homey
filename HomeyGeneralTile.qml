...
Tile {
	...
	onVisibleChanged: {
        if (visible) {
			app.tileXXXXXXXvisible = true
			if (debugOutput) console.log("*********Homey app.tileXXXXXXXvisible = true")
        }else{
			app.tileXXXXXXXvisible = false
			if (debugOutput) console.log("*********Homey app.tileXXXXXXXvisible = false")
		}
    }
