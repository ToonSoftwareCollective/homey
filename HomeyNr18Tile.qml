...
Tile {
	...
	onVisibleChanged: {
        if (visible) {
			app.tile18visible = true
			if (debugOutput) console.log("*********Homey app.tile18visible = true")
        }else{
			app.tile18visible = false
			if (debugOutput) console.log("*********Homey app.tile18visible = false")
		}
    }
