...
Tile {
	...
	onVisibleChanged: {
        if (visible) {
			app.tile11visible = true
			if (debugOutput) console.log("*********Homey app.tile11visible = true")
        }else{
			app.tile11visible = false
			if (debugOutput) console.log("*********Homey app.tile11visible = false")
		}
    }
