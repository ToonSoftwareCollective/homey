...
Tile {
	...
	onVisibleChanged: {
        if (visible) {
			app.tile12visible = true
			if (debugOutput) console.log("*********Homey app.tile12visible = true")
        }else{
			app.tile12visible = false
			if (debugOutput) console.log("*********Homey app.tile12visible = false")
		}
    }
