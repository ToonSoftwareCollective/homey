...
Tile {
	...
	onVisibleChanged: {
        if (visible) {
			app.tile10visible = true
			if (debugOutput) console.log("*********Homey app.tile10visible = true")
        }else{
			app.tile10visible = false
			if (debugOutput) console.log("*********Homey app.tile10visible = false")
		}
    }
