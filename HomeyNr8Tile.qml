...
*/
	...
	onVisibleChanged: {
        if (visible) {
			app.tile8visible = true
			if (debugOutput) console.log("*********Homey app.tile8visible = true")
        }else{
			app.tile8visible = false
			if (debugOutput) console.log("*********Homey app.tile8visible = false")
		}
    }
