...
Tile {
	...
	onVisibleChanged: {
        if (visible) {
			app.tile5visible = true
			if (debugOutput) console.log("*********Homey app.tile5visible = true")
        }else{
			app.tile5visible = false
			if (debugOutput) console.log("*********Homey app.tile5visible = false")
		}
    }
