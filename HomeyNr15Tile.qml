...
Tile {
	...
	onVisibleChanged: {
        if (visible) {
			app.tile15visible = true
			if (debugOutput) console.log("*********Homey app.tile15visible = true")
        }else{
			app.tile15visible = false
			if (debugOutput) console.log("*********Homey app.tile15visible = false")
		}
    }
