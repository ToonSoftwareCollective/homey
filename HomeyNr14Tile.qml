...
Tile {
	...
	onVisibleChanged: {
        if (visible) {
			app.tile14visible = true
			if (debugOutput) console.log("*********Homey app.tile14visible = true")
        }else{
			app.tile14visible = false
			if (debugOutput) console.log("*********Homey app.tile14visible = false")
		}
    }
