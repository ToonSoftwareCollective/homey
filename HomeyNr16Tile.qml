...
Tile {
	...
	onVisibleChanged: {
        if (visible) {
			app.tile16visible = true
			if (debugOutput) console.log("*********Homey app.tile16visible = true")
        }else{
			app.tile16visible = false
			if (debugOutput) console.log("*********Homey app.tile16visible = false")
		}
    }
