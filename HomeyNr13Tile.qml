...
Tile {
	...
	onVisibleChanged: {
        if (visible) {
			app.tile13visible = true
			if (debugOutput) console.log("*********Homey app.tile13visible = true")
        }else{
			app.tile13visible = false
			if (debugOutput) console.log("*********Homey app.tile13visible = false")
		}
    }
