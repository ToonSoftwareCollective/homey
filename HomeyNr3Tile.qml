...
Tile {
	...
	onVisibleChanged: {
        if (visible) {
			app.tile3visible = true
			if (debugOutput) console.log("*********Homey app.tile3visible = true")
        }else{
			app.tile3visible = false
			if (debugOutput) console.log("*********Homey app.tile3visible = false")
		}
    }
