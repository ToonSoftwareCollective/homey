...
Tile {
	...
	onVisibleChanged: {
        if (visible) {
			app.tile17visible = true
			if (debugOutput) console.log("*********Homey app.tile17visible = true")
        }else{
			app.tile17visible = false
			if (debugOutput) console.log("*********Homey app.tile17visible = false")
		}
    }
