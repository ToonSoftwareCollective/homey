...
Tile {
	...
	onVisibleChanged: {
        if (visible) {
			app.tile19visible = true
			if (debugOutput) console.log("*********Homey app.tile19visible = true")
        }else{
			app.tile19visible = false
			if (debugOutput) console.log("*********Homey app.tile19visible = false")
		}
    }
